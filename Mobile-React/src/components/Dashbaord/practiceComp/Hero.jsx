...
import { CloudArrowUpIcon, PaperAirplaneIcon, ServerIcon } from "@heroicons/react/24/outline";
    ...
    <div className="w-full h-screen bg-zinc-200 flex flex-col justify-between">
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        <div className="flex flex-col  justify-center md:items-start  w-full px-2 py-8">
          ...
          <button className="py-3 px-6 sm:w-[60%] my-4 text-white border bg-indigo-600 rounded-md border-indigo-600 hover:bg-transparent hover:text-indigo-600">
            Get Started
          </button>
        </div>
